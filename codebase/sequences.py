...
def passive_sequence_v1(lambd:float, 
    ...
    gamma_range,_,_ = calculate_growth_rates(indifference_etas, lambd, indifference_dx2, indiffrence_x_0)
...
def active_sequence(lambd:float, 
                    n_trials:int, 
                    indifference_etas:np.array, 
                    indiffrence_x_0:np.array, 
                    indifference_dx2:int,
    ...
    gambles,fractal_dict = create_gambles(indifference_etas=indifference_etas,lambd=lambd,dx2=indifference_dx2,x=indiffrence_x_0)
...
def generate_dataframes(lambd:float,
    ...
    p_seq_part_sum, p_seq_part_wealth_sum) = passive_sequence(lambd-lambd, 
    ...
    (a_seq_fractals, a_seq_gamma,
     a_seq_cointoss, a_seq_timings, _) = active_sequence(lambd=lambd,
